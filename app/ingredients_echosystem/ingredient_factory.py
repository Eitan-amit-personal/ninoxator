...
from app.ingredients_echosystem.ingredients.save_to_path_ingredient import SaveParameterToPathIngredient
...
class IngredientFactory(Loggable):
    ...
    def name_to_ingredient(drone: Drone, ingredient: IngredientTransport, drone_id: int) -> Union[Ingredient, list]:
        ...
        elif ingredient.name in ['ardupilot-parameters', 'lua-script']:
            return SaveParameterToPathIngredient(drone=drone, ingredient_name=ingredient.name)
