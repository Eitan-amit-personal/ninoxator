...
from app.tasks.task_upload_param_and_lua import UploadParamAndLuaTask
...
def drone_cookbook_complete_update_flow() -> bool:
    ...
    if all_successful:
        ...
        print_and_log("Uploading parameters and Lua script via Drone Technician Server")
        upload_task = UploadParamAndLuaTask(drone_connector)
        upload_task.go()
